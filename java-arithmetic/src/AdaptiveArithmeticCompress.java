 ...
 * </p>
 * <p>
 * Then use the corresponding "AdaptiveArithmeticDecompress" application to
 ...
 * and updates it after each byte encoded. The corresponding decompressor
 * program also starts with a flat
 * frequency table and updates it after each byte decoded. It is by design that
 * the compressor and
