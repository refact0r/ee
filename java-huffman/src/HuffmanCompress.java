 ...
 * </p>
 * <p>
 * Then use the corresponding "HuffmanDecompress" application to recreate the
 * original input file.
 * </p>
 * <p>
 * Note that the application uses an alphabet of 257 symbols - 256 symbols for
 * the byte values
 * and 1 symbol for the EOF marker. The compressed file format starts with a
 * list of 257
 * code lengths, treated as a canonical code, and then followed by the
 * Huffman-coded data.
 * </p>
 */
public final class HuffmanCompress {
	...
	// // The resulting generated code is optimal for static Huffman coding and also
	// canonical.
	...
	public static void main(String[] args) throws IOException {
		...
		for (File inputFile : inputFolder.listFiles()) {
			// File outputFile = new File(outputFolder, inputFile.getName() + "-java-huf");
